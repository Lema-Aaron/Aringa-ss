      ...
      <ParallaxScroll speed={0.5}>
        <div className="bg-primary text-primary-foreground py-20">
          <div className="container mx-auto px-4">
            <FadeIn>
              <h1 className="text-4xl font-bold mb-4">Aringa Secondary School: News & Events</h1>
              <p className="text-xl">Stay updated with the latest happenings at our school</p>
            </FadeIn>
          </div>
        </div>
      </ParallaxScroll>
